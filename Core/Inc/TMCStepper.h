...
class TMC2130Stepper : public TMCStepper {
	public:
		TMC2130Stepper(uint16_t pinCS, HAL_SPI *spi, float RS = default_RS, int8_t link_index = -1);
...
class TMC2160Stepper : public TMC2130Stepper {
	public:
		TMC2160Stepper(uint16_t pinCS, HAL_SPI *spi, float RS = default_RS, int8_t link_index = -1);
...
class TMC5130Stepper : public TMC2160Stepper {
	public:
		TMC5130Stepper(uint16_t pinCS, HAL_SPI *spi, float RS = default_RS, int8_t link_index = -1);
...
class TMC5160Stepper : public TMC5130Stepper {
	public:
		TMC5160Stepper(uint16_t pinCS, HAL_SPI *spi, float RS = default_RS, int8_t link_index = -1);
...
class TMC5161Stepper : public TMC5160Stepper {
	public:
		TMC5161Stepper(uint16_t pinCS, HAL_SPI *spi, float RS = default_RS, int8_t link_index = -1) : TMC5160Stepper(pinCS, spi, RS) {}
