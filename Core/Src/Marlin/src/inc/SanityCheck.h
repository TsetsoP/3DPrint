 ...
 */
  ...
  #define _PIN_CONFLICT(P) (PIN_EXISTS(P) && P##_PIN == SPINDLE_LASER_PWM_PIN)
    ...
    #elif ENABLED(SPINDLE_LASER_POWERUP_DELAY) && SPINDLE_LASER_POWERUP_DELAY < 1 //my edit
      #error "SPINDLE_LASER_POWERUP_DELAY must be greater than 0."
    #elif ENABLED(SPINDLE_LASER_POWERDOWN_DELAY) && SPINDLE_LASER_POWERDOWN_DELAY < 1 //my edit
